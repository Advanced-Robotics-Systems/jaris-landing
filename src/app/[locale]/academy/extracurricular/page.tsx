...
const Extracurriculur = () => {
  ...
  const contentMap = [
    ...
    },
    {
      ...
      cta: {
        description: botanicCTADescription,
        imgSrc: botanicOverview.imgSrc,
      },
    },
    {
    ...
    },
    {
      ...
      cta: {
        description: aerobicsCTADescription,
        imgSrc: aerobicsOverview.imgSrc,
      },
    },
  ];

  const t = useTranslations("extracurricularPage");
