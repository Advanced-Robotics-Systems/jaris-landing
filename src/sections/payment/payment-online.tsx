	...
	return (
		<div className="flex flex-col lg:flex-row justify-between padding bg-bg-primary lg:px-64 xl:px-80 2xl:px-96 gap-10">
			...
			<Card className="flex-1 bg-jaris-blue text-jaris-white rounded-lg p-6 lg:h-[320px]">
				...
				<CardFooter>
					<Button size="lg" className="mt-auto" color="warning">
						Pay Online
					</Button>
				</CardFooter>
			</Card>
			...
			<Card className="flex-1 bg-white shadow-lg rounded-lg p-6 flex flex-col lg:h-[320px]">
				...
				<CardBody className="flex-grow text-jaris-blue grid grid-cols-5 gap-4">
				...
				<CardFooter>
					<Button
						...
						onPress={handleCopy}
					>
						 <span className="transition-opacity duration-300">{copied ? "Copied!" : "Copy"}</span>
					</Button>
				</CardFooter>
			</Card>
		</div>
