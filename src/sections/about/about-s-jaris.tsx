    ...
    >
      ...
      <div className="relative z-10 lg:w-2/3">
        ...
        <p className="text-bg-text mt-4 leading-7 subtitle">
          Second Jawahir Al-Riyadh International School (2nd JARIS), an
          educational powerhouse established in 1998 with the Saudi Ministry of
          Education. Our commitment to excellence is showcased through our
          affiliation with Advance-Ed, an American Affiliation , since December
          2015, 2nd JARIS proudly serves as an Examination Center for College
          Board.
        </p>
