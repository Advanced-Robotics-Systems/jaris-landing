      ...
      <div className="lg:flex gap-8 lg:gap-16 w-full max-container">
        ...
        <div className="p-8 rounded-lg lg:flex-1">
          ...
          <p className="text-base md:text-lg text-jaris-blue-light mt-4">
            ...
            inspired to actively engage in their learning, supported by
            teachers and technology, and prepared to confidently take on the
      ...
      <div className="flex flex-col lg:flex-row-reverse gap-8 lg:gap-16 w-full max-container">
        ...
        <div className="p-8 rounded-lg lg:flex-1">
          ...
          <p className="text-base md:text-lg text-jaris-blue-light mt-4">
            ...
            advanced technology, and supporting individualized education, we
            aim to guide each student towards their full potential.
          </p>
        </div>
