...
const AboutTJaris = () => {
	return (
		<div
			...
			style={{
				backgroundImage: "url(/images/about/tjaris-bg.jpeg)",
			}}
		>
			...
			<div className="relative z-10 lg:w-2/3">
				...
				<p className="text-bg-text mt-4 leading-7 subtitle">
					Third Jawahir Rl-Riyadh International School (TJARIS) is the recently
					(the independent) opening of Jawahir Al-Riyadh Educational Company
					(JAREC) for female students managed by female educationists. Most of
					the teaching staff already serving with JAREC were relocated in this
					important phase of the COMPANY.
				</p>
