export const faqContents = [
  ...
  },
  {
    ...
    answer:
      "The withdrawal policy allows parents to withdraw their child at any point during the academic year, but fees will only be refunded according to the school's terms, which are based on the timing of the withdrawal and whether the child has already attended classes.",
  },
  {
    id: 3,
    question:
  ...
  {
    id: 7,
    question: "Can I pay my fees through a bank transfer?",
    answer:
      "Yes, the school accepts fee payments via bank transfer. Details regarding payment methods will be shared by the school administration.",
  },
  {
    id: 8,
    question: "What are the school hours?",
    answer:
      "School hours are from 7:30 AM to 2:30 PM, Sunday through Thursday.",
  },
  {
    id: 9,
    question:
      "What are the modes of communication between the parents and the school?",
    answer:
      "Parents can communicate with the school through email, the school's mobile app, and regular parent-teacher meetings.",
  },
  {
    id: 10,
    question: "When should I take the SAT?",
    answer:
      "It is recommended to take the SAT during Grade 11 or 12 to ensure students have covered the necessary material.",
  },
  {
    id: 11,
    question:
  ...
  },
  {
    id: 16,
    question:
      "Will my children be able to easily transition to another curriculum if we travel abroad?",
    answer:
      "Yes, as an internationally accredited school, your children will be able to transition smoothly to other international curricula.",
  },
  {
    id: 17,
    question:
      "What documentation do I need if my student is transferring from another school in Saudi Arabia or from abroad?",
    answer:
      "You will need previous school transcripts, a transfer certificate, and other required documents as listed by the admissions team during the transfer process.",
  },
  {
    id: 18,
    question: "How are my students assessed?",
    answer:
      "Students are assessed through a combination of continuous assessment, exams, and projects to ensure a comprehensive understanding of the material.",
  },
  {
    id: 19,
  ...
  {
    id: 20,
    question: "Will my child be required to pursue an IB-DP diploma?",
    answer:
      "No, pursuing the IB-DP diploma is optional. Students can choose the pathway that best suits their academic and career goals.",
  },
  {
    id: 21,
    question: "How to Start Classera?",
    answer:
      "To start using Classera, log in with the credentials provided by the school. You will have access to your child’s assignments, grades, and communication with teachers. Follow the step-by-step guide available on the school’s website for any assistance.",
  },
];
