const ContactExperienceCard = ({
  ...
  return (
    <div className="flex flex-col bg-bg-primary rounded-2xl w-full md:w-[45%] lg:w-[30%] h-40 md:h-56 p-4 md:p-6 lg:p-8">
      ...
      {index == 5 && (
        <div className="mt-3">
          <span className="text-jaris-blue text-sm sm:text-base md:text-lg lg:text-xl font-medium">
            {title.split(" ")[0]}
          </span>{" "}
          <span className="text-red-900 text-sm sm:text-base md:text-lg lg:text-xl font-medium">
            {title.split(" ")[1]}
          </span>
        </div>
      )}
