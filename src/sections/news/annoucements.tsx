...
const Announcements = () => {
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row max-sm:gap-y-6 justify-around bg-bg-primary padding">
        {/* Left Side Starts */}
        <div className="basis-full sm:basis-2/5 flex sm:items-center sm:min-h-96 max-sm:order-2">
          <div className="w-full flex flex-col gap-y-6">
            <h1 className="text-5xl lg:text-6xl xl:text-7xl text-jaris-gold font-semibold">
              Age Criteria
            </h1>
