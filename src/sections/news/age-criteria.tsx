...
const AgeCriteria = () => {
  return (
    <div className="flex flex-col sm:flex-row max-sm:gap-y-6 justify-between bg-bg-primary padding md:px-20 lg:px-28 xl:px-40 2xl:px-[15%]">
      {/* Left Side Starts */}
      <div className="basis-full sm:basis-2/5 flex sm:items-center sm:min-h-96 max-sm:order-2">
        <div className="w-full flex flex-col gap-y-6">
          ...
          <p className="text-sm sm:text-base font-normal text-jaris-blue">
          ...
          <Button
            size="lg"
            radius="sm"
            className="bg-jaris-gold text-sm sm:text-base lg:text-lg font-bold text-bg-text w-3/5 sm:w-full md:w-3/5 xl:w-1/2"
          >
            Download Criteria
          </Button>
        </div>
